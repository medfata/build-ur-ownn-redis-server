...
public class IncrementCommand implements RedisCommand {
    ...
    public IncrementCommand(RedisMap redisMap, RedisTimestampMap redisTimestampMap){
        this.redisMap = redisMap;
        this.redisTimestampMap = redisTimestampMap;
    }
    @Override
    public Object execute(String[] args) {
        GetCommand keyExistsCommands = new GetCommand(redisMap, redisTimestampMap);
        String res = keyExistsCommands.execute(args);
